    ...
    <div className="min-h-screen bg-[#0f111a] text-white p-8">
      <div className="max-w-[800px] mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">Manage your company details and representative information.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#161b22] border border-[#1e293b] rounded-xl p-8 space-y-6 shadow-lg">
          ...
          <div className="space-y-4 pt-4">
            <h3 className="text-lg font-bold border-b border-[#1e293b] pb-2">Company Identity</h3>
